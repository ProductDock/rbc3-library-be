...
public class BookSetUp {
  ...
  static final String BOOK_STATUS = "AVAILABLE";

  static final BookStatus BOOK_STATUS_ENUM = BookStatus.AVAILABLE;
  ...
  static final List<BookCategory> BOOK_CATEGORIES_ENUM = List.of(BookCategory.MARKETING);
  static final List<BookCategoryDto> BOOK_CATEGORIES_DTO = List.of(BookCategoryDto.MARKETING);
  static final String BOOK_CATEGORY = "MARKETING";
  ...
  static Book createBook1() {
    return Book.builder()
        ...
        .bookCategories(BOOK_CATEGORIES_ENUM)
        .build();
  }
